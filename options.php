...
$aTabs = array(
    array("DIV" => "edit1", "TAB" => GetMessage('SEO2_MAIN'), "ICON" => "", "TITLE" => GetMessage("SEO2_MAIN_TITLE")),
...
$arAllOptions = Array(
    //Array("max_levels", GetMessage("SEO2_TEST_MAX_LEVELS")." ", Array("text", 5)),
    //Array("max_answers", GetMessage("SEO2_TEST_MAX_ANSWERS")." ", Array("text", 5)),
    array("REDIRECTS_IS_ACTIVE", GetMessage("SEO2_REDIRECTS_IS_ACTIVE")." ", array("checkbox")),
    array("404_IS_ACTIVE", GetMessage("SEO2_404_IS_ACTIVE")." ", array("checkbox")),
    array("VALIDATE_URL_BY_RFC2396", GetMessage("SEO2_VALIDATE_URL_BY_RFC2396")." ", array("checkbox")),
    array("404_LIMIT", GetMessage("SEO2_404_LIMIT")." ", array("select", array(
        '0' => GetMessage('SEO2_404_LIMIT_ALL'),
        '1000' => '1000 '.GetMessage('SEO2_404_LIMIT_LAST_N'),
        '2000' => '2000 '.GetMessage('SEO2_404_LIMIT_LAST_N'),
        '3000' => '3000 '.GetMessage('SEO2_404_LIMIT_LAST_N'),
        '4000' => '4000 '.GetMessage('SEO2_404_LIMIT_LAST_N'),
        '5000' => '5000 '.GetMessage('SEO2_404_LIMIT_LAST_N'),
    )),),
);
...
if(count($arMsg))
{
    if($e = $APPLICATION->GetException())
        $message = new CAdminMessage(GetMessage("SEO2_OPTIONS_ERROR"), $e);
    $bVarsFromForm = true;
}
