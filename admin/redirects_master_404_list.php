...
while ($arResult = $dbResultList->NavNext(true, "f_")) {
    $createRuleURL = "redirects_master_edit.php?ADD=Y&lang=".urlencode(LANG)."&site_id=$f_SITE_ID&OLD_LINK=".urlencode($f_URL);
    $ignoreURL = "redirects_master_404_ignore_edit.php?ADD=Y&lang=".urlencode(LANG)."&site_id=$f_SITE_ID&OLD_LINK=".urlencode($f_URL);
...
$aContext = array(
		array(
				...
				"ICON" => "",
				"LINK" => 'redirects_master_404_report.php?lang='.urlencode(LANG)
		),
);
