...
while ($arResult = $dbResultList->NavNext(true, "f_")) {
    ...
    $arActions[] = array("ICON" => "list", "TEXT" => GetMessage("SEO2_SHOW_LIST"), "ACTION" => $lAdmin->ActionRedirect("collected_redirects_404_list.php?lang=".LANG."&set_filter=Y&filter_url=".  urlencode($f_URL)), "DEFAULT" => false);
...
$aContext = array(
		array(
				...
				"ICON" => "",
				"LINK" => 'collected_redirects_404_list.php?lang='.urlencode(LANG)
		),
);
