...
$MESS ['SEO2_INFORMATION_TITLE'] = 'Внимание!';
$MESS ['SEO2_INFORMATION_DESC'] = "<i>Редирект мастер</i> вносит изменения в файл <i>.htaccess</i>! <br/>Перед применением модуля рекомендуется сделать резервную копию файла и <a href='http://httpd.apache.org/docs/2.4/mod/mod_alias.html#redirect' target='_blank'>ознакомиться с официальной документацией Apache</a>.";
$MESS ['SEO2_ERROR_DUPLICATE_OLD_LINK'] = "С данного URL уже настроен редирект!";
$MESS ['SEO2_WITH_INCLUDES'] = 'все вхождения';
$MESS ['SEO2_WITH_INCLUDES_TIP'] = 'Данный признак означает, что редирект надо проводить со всех url, начинающихся с указанного.<br/><br/><i>Например, если задать url вида /prt  и указан признак &quot;все вхождения&quot;, то редирект будет производится и с /ptr12 и /prt13 и /prt/help/  и т.д.</i>';
$MESS ['SEO2_USE_REGEXP'] = 'Использовать регулярные выражения';
$MESS ['SEO2_USE_REGEXP_DESC'] = '<a href="http://www.step2use.com/blog/complex-rules-of-redirects/" target="_blank">пример использования</a>'
?>